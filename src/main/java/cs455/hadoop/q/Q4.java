...
public class Q4 {
    ...
    public static class Q4Mapper extends Mapper<Object, Text, Text, Text> {
    ...
    public static class Q4Reducer extends Reducer<Text, Text, Text, DoubleWritable> {
